...
TRANSLATIONS = {
    "en": {
        ...
        # Extended Gantt (actual + proposed)
        "gantt_extended_title": "Daily Schedule (Actual + Proposed)",
        "gantt_extended_note": "⚠️ **Note:** ✓ = actual hours logged | 📍 = today | plain numbers = proposed schedule",
        "gantt_extended_legend": "**Legend:** ✓ = actual logged | 📍 = today | ✅ = on-time | ⚠️ = late | ↑Xh = need X more hours",
    ...
    "vi": {
        ...
        "gantt_extended_note": "⚠️ **Lưu ý:** ✓ = giờ đã log | 📍 = hôm nay | số = lịch đề xuất",
        "gantt_extended_legend": "**Chú thích:** ✓ = đã log | 📍 = hôm nay | ✅ = đúng hạn | ⚠️ = trễ | ↑Xh = cần thêm X giờ",
    ...
    "ja": {
        ...
        # Extended Gantt (actual + proposed)
        "gantt_extended_title": "日別スケジュール（実績 + 提案）",
        "gantt_extended_note": "⚠️ **注:** ✓ = ログ済み実績 | 📍 = 今日 | 数字 = 提案スケジュール",
        "gantt_extended_legend": "**凡例:** ✓ = ログ済み | 📍 = 今日 | ✅ = 期限内 | ⚠️ = 遅延 | ↑Xh = X時間追加必要",
