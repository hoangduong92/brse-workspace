...
- [ER Diagram](../../projects/solo-builder-12months/ship/backlog-clone/docs/er-diagram.md)
...
Create all 13 database tables in Supabase with proper relationships, constraints, and indexes.

## Tables Summary

| Type | Tables | Count |
|------|--------|-------|
| Entity | organizations, users, projects, issues, documents, comments | 6 |
| Junction | project_members, issue_categories | 2 |
| Lookup | roles, statuses, issue_types, categories | 4 |
| Auth | profiles (extends Supabase auth.users) | 1 |
| **Total** | | **13** |
...
- [x] 1. Create new Supabase project (or use existing)
- [ ] 2. Navigate to SQL Editor in Supabase Dashboard
- [x] 3. Run the migration SQL above - Created `supabase/migrations/001_initial_schema.sql`
- [ ] 4. Verify all 13 tables created via Table Editor - Requires running migration in Supabase
- [ ] 5. Test triggers by creating test org and project - Requires running migration in Supabase
- [x] 6. Generate TypeScript types - Created `src/types/database.ts` with all 13 tables
...
-- Expected: 13 tables
-- categories, comments, documents, issue_categories, issue_types,
-- issues, organizations, profiles, project_members, projects,
-- roles, statuses
```

## TypeScript Types

After running schema, generate types:
...
After schema is ready → [Phase 2: Organizations & Users CRUD](./phase-02-organizations-users.md)
